...
def main():
    ...
    result = {
        ...
        "optimizer_limitation": "fresh Adam; checkpoint optimizer state unavailable",
    ...
    try:
        ...
        trainer.global_step = args.start_epoch * train_config["batch_size"]
        ...
        current_lr = train_config["learning_rate"] * lr_factor
